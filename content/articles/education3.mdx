...
While there is sufficient evidence to prove that Lazar intended to get a University degree,
there is none that proves he ever got one. We can safely assume that Lazar was taking
transfer classes in 1978-79 at Pierce so that he could continue his education at a more advanced school,
but that alone is not proof that he did. It is also not proof that he didn't.
...
As discussed previously the timeline of these degrees would have been:
...
however we have some eye witness testimony that suggests that Lazar at least went to Caltech some time in the past.
...
> <audio controls><source src="/audio/george-caltech.mp3" type="audio/mpeg"/></audio>
>
...
> <audio controls><source src="/audio/john-lear-degrees.mp3" type="audio/mpeg"/></audio>
>
...
That being said how come there are no documents available that proves Lazar's attendance at Caltech or MIT and last but not least Cal State Northridge?
...
Does this mean that Lazar did not attend Cal State Northridge? Far from it. You see Northridge unlike Pierce is not willing to share anyone's directory information.
Thus when Stanton Friedman inquired about Lazar they probably refused to give him any records and that is why he "drew a blank on Lazar at Cal State Northridge".

If Lazar would have finished a Bachelor degree at Northridge then he should have been included in their yearbook, however he never
claimed to have gotten any degrees from Northridge. Lazar only stated that he went to Northridge for a few classes, and if that is
...
The California Institute of Technology used to share the list of students who finished their graduate program in their course catalog.
Unfortunately they have stopped doing that only a few years before 1982 when Lazar should have obtained his degree. Since the master's program
at Caltech did not require a thesis we cannot say that any are missing. Given that the only other
publicly available and verifiable document was the yearbook of Caltech (the Big T) and since graduates weren't included in it, there are no
...
to obtain any of them after all the time that has gone by.
...
It is not impossible that Lazar's records were physically removed, but a fare more simpler solution would have been to classify them as state secret.
...
student records would most likely be Executive Order 12356.
...
as they report the act to the Director of the Information Security Oversight Office. There may be other reason's why Lazar's records
...
Most records at the Massachusetts Institute of Technology could have been just as easily classified as any other record the government
considered a risk. On the other hand there were significantly more public data from MIT circulating in various places compared to what has been discoverable at Caltech.
Glenn Campbell in particular has spent much time trying to find Lazar's name in the records of MIT. He concluded that:
...
> <audio controls><source src="/audio/mellon-rogan.mp3" type="audio/mpeg"/></audio>
>
...
This is something Lazar never stated before, however it would fill in a lot of blanks in his story if it was true.
If Lazar did work on some horrible weapons project at Los Alamos Labs which required him to be sent to MIT, then that project could have been easily used to classify
all of Lazar's records from MIT, LANL and Caltech. An off the record black project at a secret location next to an undisclosed military base would have been much less practical
for such a purpose.
...
...and in a much earlier letter sent to Los Alamos Labs in 1990 Lazar made the claim that:
...
the assertion that Lazar worked on weapons at Los Alamos Labs is not. One curiosity in regards
to his above comment though is that he is claiming that he was employed as a physicist in 1982
and we know from multiple sources including LANL that he began working at the lab as a technician
in the summer of 1982. It is quite an upgrade to go from technician to physicist in no more than
7 months. Is this possible?
...
been some time between October 21 and February 11, which does make the year 1982 a viable option for the job switch. If however he did get another job at LANL
then his name should have been still in the phonebook, however since only the redacted version obtained through FOIA is available and not the original phonebook
...
After all, the phone numbers were based on lab location and there would have been no need for somebody living and studying in Massachusetts to be given a number for Los Alamos.

Another interesting tidbit is that according to ex NASA contractor Bob Oechsler, Lazar's tax records were also missing from year 1983 and after:
...
Furthermore the classification of Lazar's records at MIT due to national security reasons would explain why Lazar was evasive in supplying the the date for his graduation at MIT.
...
If Lazar was no at liberty disclosing the date of graduation then a simple solution would have been to lie.
...
> <audio controls><source src="/audio/jre-lazar-edu.mp3" type="audio/mpeg"/></audio>
>
> Rogan - There is your education record that was also like that, what happened with that?
>
...
>
> Lazar - Well I gave Jeremy some names, but people, yeah I. The reason I don't say these names publicly is because every single time I mention a name somebody gets injured.
>
...
be blocked from being released to the public ad infinitum. They were right. This would not have happened at Stanford given the rules every student must accept before beginning their work on their thesis.
...
a "special subcommittee" will have to determine how the thesis may eventually be allowed to get published. It doesn't really have to be published, they
are only there to give a recommendation and even if they conclude that the thesis cannot be released it would not affect the outcome.

Since MIT is willing to accept students who's thesis will be classified from day one to the end of times, it should not surprise anyone
...
that anyone making any conclusion based on lack of evidence is only sharing their opinion, nothing more, nothing less.
