...
Unfortunately they have stopped doing that only a few years before 1982 when Lazar should have obtained his degree.
...
are only there to give a recommendation and even if the committee determines the thesis cannot be published, it does not impact the student's degree..
