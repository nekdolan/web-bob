...
Although English and History could have been part of the General Education Requirement, many other subjects were also available to fulfill it.
It should also be noted that the Electronics Service Technology program required earning a certificate after one year, and according to Pierce College, no certificate was granted to Lazar.
...
As a result, Pierce College may have revoked degrees earned by individuals who took courses at Pacifica University, but by that time, Lazar may have already obtained a more advanced degree.
